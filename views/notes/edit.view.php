...
<main class="p-10">
  <form method="POST" action="/note/update">
    ...
    <div class="mt-6 flex items-center gap-x-6">
      <a href="/notes"
        class="rounded-md bg-gray-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-950 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Councel</a>
      <button type="submit"
