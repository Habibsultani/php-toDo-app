  ...
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img class="mx-auto h-10 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
        alt="Your Company">
      <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900"> Register here
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="register" method="POST">
        ...
        <?php if(isset($error)) : ?>
        <p class="mt-3 text-red-500 text-sm leading-6 text-gray-600"><?= $error['email'] ?? '' ?></p>
        <?php endif; ?>
        ...
        <?php if(isset($error)) : ?>
        <p class="mt-3 text-red-500 text-sm leading-6 text-gray-600"><?= $error['password'] ?? '' ?></p>
        <?php endif; ?>
